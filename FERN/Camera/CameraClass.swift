            ...
            if status == .authorized {
                PHPhotoLibrary.shared().performChanges({
                    ...
                    do {
                        ...
                        try _ = FieldWorkGPSFile.log(tripName: tripName, uuid: fileNameUUID, gps: gps, hdop: hdop, longitude: longitude, latitude: latitude, altitude: altitude, scannedText: "", notes: "")
                    } catch {
