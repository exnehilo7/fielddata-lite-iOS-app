...
#pragma mark - Proprietary messages

/**
 * PLTIT
 * Horizontal Vector (HV) Download Message
 */
typedef struct _PLTITHVINFO
{
	double  hd_value;
	char    hd_value_units;
	double  az_value;
...
/**
 * PLTIT
 * Height (HT) Download Message
 */
typedef struct _PLTITHTINFO
{
	double  value;
	char    value_units;
} PLTITHTINFO;
...
/**
 * PLTIT
 * Missing Line (ML) Download Message
 */
typedef struct _PLTITMLINFO
{
	double  hd;
	char    hd_units;
	double  az;
...
/**
 * Information about TruePulse Laser Range Finder
 * PLTIT
 */
typedef struct _PLTITINFO
{
	PLTITHVINFO HVInfo;
	PLTITHTINFO HTInfo;
	PLTITMLINFO MLInfo;
...
typedef struct _nmeaINFO
{
	...
	PLTITINFO PLTITInfo;		/**< PLTIT device information */
} nmeaINFO;
...
typedef enum _nmeaVersion
{
    ...
    nmeaVersion411      // Supports $GP-GPS(1), $GL-Glonass(2), $GA-Galineo(3), $GB-Beidou(4), $GQ-QZSS(5), $GI-NavIC/IRNSS(6)
} nmeaVersion;
